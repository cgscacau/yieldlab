        ...
        <div class="bg-white rounded-lg shadow-2xl p-8 max-w-6xl w-full mx-4 my-8">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex items-center space-x-3">
                    <button onclick="dashboard.updateQuotes()" class="bg-blue-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-blue-700 text-sm flex items-center">
                        <i class="fas fa-sync-alt mr-2"></i>Atualizar Cotações
                    </button>
                    ...
                    <table class="w-full">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Data de Compra</th>
